                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="container">
                                ...
                                <form action="{{ route('store.materialout') }}" method="POST">
                                    @csrf
                                    <!-- Purchase Request Fields -->

                                    <div class="text-center">
                                        <h4>ADD MATERIAL OUT</h4>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group row">
                                                <label for="allocation" class="col-sm-3 col-form-label">Allocation</label>
                                                <div class="col-sm-9">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group row">
                                                <label for="remark" class="col-sm-4 col-form-label">Date</label>
                                                <div class="col-sm-5">
                                    ...
                                    <a href="{{ route('all.materialout') }}" class="btn btn-danger mt-2">Back</a>
                                </form>
                            </div>
