    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function calculateTotals() {
                ...
                $('#pph_end').val(pphAmount.toLocaleString('en-US')); // Update PPH

                // Calculate grand total
                const grandTotal = (subTotal + taxAmount) - pphAmount;
            ...
            $(document).on('input', '.qty, .price, #rounding, #tax,#pph', function() {
                calculateTotals();
            });
