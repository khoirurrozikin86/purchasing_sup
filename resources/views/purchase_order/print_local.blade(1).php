...
<head>
    <style>
        ...
        .footer {
            ...
            position: absolute;
            bottom: 10px;
            /* Posisikan footer sedikit di atas tepi bawah */
            left: 0;
            font-size: 8px;
            text-align: left;
            /* Atur teks ke kiri */
...
<body>
    ...
    <div class="content">
        ...
        <table class="table detail-request table-detail-request" style="font-size: {{ count($purchaseorder->detailorder) > 10 ? '8px' : '10px' }}">
            <thead>
                <tr>
                    <th>No</th>
                    <th>Code</th>
        ...
        <div class="footer">
            <p>
                Factory: Jl. Raya Tegalpanas Jimbaran Dsn Secang RT 01 Ds Samban Kec. Bawen Kab. Semarang Jawa Tengah
                Telp: (0298) 523720
            </p>
            <p>
                Head Office: Summitmas II 3rd Fl. Jl. Jend. Sudirman Kav 61-62, Jakarta 12190 Telp: (021) 520 1294
            </p>
        </div>
