                ...
                <div class="row">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="myForm" class="forms-sample" method="POST" action="{{route('pdf.employee')}}" enctype="multipart/form-data">
                                @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadEmployeeData() {
                $.ajax({
                    url: "{{ route('get.posisiemployee') }}", // Adjust to your route
                    method: 'GET',
                    headers: {
                        'X-CSRF-TOKEN': token
                    },
                    success: function(response) {
                        if (table) {
                            ...
                            $('#dataTableExamples tbody').on('click', 'tr', function() {
                                ...
                                $('#posisi').val(data[0]);
                                $('#employeeModal').modal('hide'); // Hide modal after selection
                            });
                        }
                    },
